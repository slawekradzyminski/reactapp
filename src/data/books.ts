const books = [
  {
    ...
    link: "https://amzn.to/49HqvB3",
    path: "downloaded_covers/Staff_Engineer:_Leadership_beyond_the_management_track.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/4b2Ei6y",
    path: "downloaded_covers/The_Staff_Engineers_Path.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/3Q8C0e3",
    path: "downloaded_covers/The_Software_Engineers_Guidebook.jpg",
    description:
...

  {
    ...
    link: "https://amzn.to/4d3hgOD",
    path: "downloaded_covers/Understanding_Distributed_Systems.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/3UBWwqd",
    path: "downloaded_covers/Fundamentals_of_Software_Architecture.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/3UrBR7V",
    path: "downloaded_covers/Software_Architecture___the_Hard_Parts.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/448eHGU",
    path: "downloaded_covers/System_Design_Interview___Volume_1.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/4aIOTDJ",
    path: "downloaded_covers/System_Design_Interview___Volume_2.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/4aH08g8",
    path: "downloaded_covers/Continuous_Delivery.jpg",
    description:
...

  {
    ...
    link: "https://amzn.to/3wkfzvx",
    path: "downloaded_covers/Implementing_Lean_Software_Development.jpg",
    description:
  ...
  {
    title: "Lean Startup",
    link: "https://amzn.to/3JCSNSJ",
    path: "downloaded_covers/Lean_Startup.jpg",
    description:
...

  {
    ...
    link: "https://amzn.to/3WpTpCG",
    path: "downloaded_covers/Steal_Like_An_Artist.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/4dk2Dqc",
    path: "downloaded_covers/Show_Your_Work.jpg",
    description:
  ...
  {
    title: "Keep Going",
    link: "https://amzn.to/3JEkBpW",
    path: "downloaded_covers/Keep_Going.jpg",
    description:
  ...
  {
    title: "Antifragile",
    link: "https://amzn.to/4d9rD3E",
    path: "downloaded_covers/Antifragile.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/3xFx2yS",
    path: "downloaded_covers/The_Black_Swan.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/3xTxERI",
    path: "downloaded_covers/Fooled_by_Randomness.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/4d0rL5r",
    path: "downloaded_covers/Skin_in_the_Game.jpg",
    description:
  ...
  {
    title: "Full Incerto - all Taleb books in one",
    link: "https://amzn.to/3W1TsEO",
    path: "downloaded_covers/Full_Incerto___all_Taleb_books_in_one.jpg",
    description:
...

  {
    ...
    link: "https://amzn.to/4b6SYBF",
    path: "downloaded_covers/Surely_Youre_Joking,_Mr_Feynman.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/445WA4z",
    path: "downloaded_covers/What_Do_You_Care_What_Other_People_Think.jpg",
    description:
...

  {
    ...
    link: "https://amzn.to/3Ugho4W",
    path: "downloaded_covers/Leonardo_da_Vinci___Biography.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/3U8m6RZ",
    path: "downloaded_covers/How_to_Think_Like_Leonardo_da_Vinci.jpg",
    description:
...

  {
    ...
    link: "https://amzn.to/4473vKA",
    path: "downloaded_covers/Boyd:_The_Fighter_Pilot_Who_Changed_the_Art_of_War.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/3xHSWBQ",
    path: "downloaded_covers/The_Mind_of_War:_John_Boyd_and_American_Security.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/3JsZ7Mz",
    path: "downloaded_covers/Certain_to_Win:_The_Strategy_of_John_Boyd,_Applied_to_Business.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/4b3GN8B",
    path: "downloaded_covers/Science,_Strategy_and_War_(Strategy_and_History).jpg",
    description:
...

  {
    ...
    link: "https://amzn.to/3Ux6qt1",
    path: "downloaded_covers/Public_Relations.jpg",
    description:
  ...
  {
    title: "Clean Code",
    link: "https://amzn.to/3WHeDvY",
    path: "downloaded_covers/Clean_Code.jpg",
    description:
      "Clean Code is a revolutionary handbook that teaches readers how to write clean, efficient code through principles, patterns, and practices. With case studies and heuristics, readers will learn how to transform bad code into good code, create good names and functions, format code for readability, and more. This book is essential for anyone in the software development field who wants to become a better programmer.",
  },
  {
    title: "Tidy First",
    link: "https://amzn.to/3UTDxrb",
    path: "downloaded_covers/Tidy_First.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/4bdfyc0",
    path: "downloaded_covers/Professional_Javascript_for_Web_Developers.jpg",
    description:
  ...
  {
    title: "Atomic Habits",
    link: "https://amzn.to/3UTzj2G",
    path: "downloaded_covers/Atomic_Habits.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/3VnwxmL",
    path: "downloaded_covers/The_Charisma_Myth.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/3yIWcNT",
    path: "downloaded_covers/The_Laws_of_Human_Nature.jpg",
    description:
  ...
  {
    title: "Mastery",
    link: "https://amzn.to/3WFYozD",
    path: "downloaded_covers/Mastery.jpg",
    description:
  ...
  {
    title: "Influence",
    link: "https://amzn.to/3X5lJLh",
    path: "downloaded_covers/Influence.jpg",
    description:
...

  {
    ...
    link: "https://amzn.to/3KlMjbt",
    path: "downloaded_covers/Creativity_Inc.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/3Km7vhc",
    path: "downloaded_covers/Project_Phoenix.jpg",
    description:
...

  {
    ...
    link: "https://amzn.to/3Ko17pT",
    path: "downloaded_covers/Thinking_Fast_and_Slow.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/4aIMLvQ",
    path: "downloaded_covers/Thinking_in_Systems.jpg",
    description:
  ...
  {
    title: "The Goal",
    link: "https://amzn.to/3R56bTF",
    path: "downloaded_covers/The_Goal.jpg",
    description:
  ...
  },
  {
    ...
    link: "https://amzn.to/3R8tQCL",
    path: "downloaded_covers/Shackletons_Way.jpg",
    description:
